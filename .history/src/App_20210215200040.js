    ...
    <div>
      <div className="section1 ">
        ...
        >
          ...
          <div id="main1">
            <div
              style={{ backgroundColor: "green", height: 485, paddingTop: 50 }}
            >
              <div
                className="col-12"
                style={{
      ...
      <div style={{ height: 130, backgroundColor: "white" ,display:"flex",justifyContent:"center",alignItems:"center",flexDirection:"center",position:"relative"}}>
        <Col>
          {" "}
          Dubai-the perfect launch pad to take businessto a global level
        </Col>
        <Row>
          <div className="col-4">
            <Row>
