    ...
    <div>
      <div className="section1 ">
        ...
        >
          ...
          <div id="main1">
            <div style={{ backgroundColor: "green",height:245,paddingTop:50}}>
            ...
            <div style={{ backgroundColor: "orange" }}>
              ...
              <div style={{height:520,borderRadius:5,backgroundColor:'green',border:1,borderColor:'black'}}>
                <div style={{height:25,backgroundColor:'green'}}>
                  <div>Enquire Now
                    </div>
                    <div style={{padding:25,backgroundColor:'orange'}}>
                  <div></div>YOUR NEW OFFICE IN DUBAI IS JUST A CLICK AWAY
                    </div>
                  </div>
                </div>
            </div>
