    ...
    <div>
      <div className="section1 ">
        ...
        >
          ...
          <div id="main1">
            <div
              style={{ backgroundColor: "green", height: 245, paddingTop: 50 }}
            >
              <div
                className="col-12"
                style={{
            ...
            <div
              style={{ backgroundColor: "green", height: 245, paddingTop: 50,flexDirection:"column" }}
            ></div>
            ...
            <div style={{}}>
              ...
              >
                <div className="formheader1">
                  Enquire <span style={{color:'orange',paddingLeft:5}}>Now</span>
                </div>
...
<button className="submitbutton">Submit</button>                </div>
              </div>
            </div>
          </div>
        </div>
