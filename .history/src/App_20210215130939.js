    ...
    <div>
      <div className="section1 ">
        ...
        >
          ...
          <div id="main1">
            <div style={{ backgroundColor: "green",height:272,padding:5,}}>
              <div className="col-12" style={{height:100,display:"flex",justifyContent:"flex-start",alignItems:"center",textAlign:"left"}}> <h1>REACH FOR SKIES</h1></div>
