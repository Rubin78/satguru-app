    ...
    <div>
      <div className="section1 ">
        ...
        >
          ...
          <div id="main1">
            <div style={{ backgroundColor: "green",height:272,padding:5,justifyContent:"center",display:"flex",flexDirection:"column"}}>
              <div className="col-12"> <h1>REACH FOR SKIES</h1></div>
