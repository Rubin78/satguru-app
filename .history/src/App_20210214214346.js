    ...
    <div>
      ...
      <div className="section7">
        <Row>
          <Col md="1"></Col>
          <Col md="7">
            <div style={{ height: 450, backgroundColor: "red", padding: 25 }}>
              ...
              <Col md="12" style={{backgroundColor:"orange" ,display:'flex',justifyContent:'flex-end'}}>
                <Button>Book A Visit</Button>
              </Col>
            </div>
          </Col>
          <Col md="4">
            <div style={{ height: 450, backgroundColor: "red", padding: 20 }}>
