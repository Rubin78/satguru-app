                        ...
                        <div className="content">
                          ...
                          <Row>
                            <Col md="6" className="coltext">
                              <div className="coltextinside">‣ Cutting edge technology</div>
                              <div>‣ Stylish visitors reception</div>
                            ...
                            <Col md="6" className="coltext">
                              <div>‣ High speed Wi-Fi</div>
                              <div>‣ Dedicated P.O.Box and Mail</div>
                              <div>‣ Management & </div>
                              <div>Housekeeping Support </div>
                              <div>‣ Kitchen Amenities</div>
